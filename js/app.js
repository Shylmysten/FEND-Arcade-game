  ...
  allEnemies.forEach(enemy => {
    ...
    if (
      ...
      if (gameData.livesLeft === 0) {
        ...
        message.innerHTML = `
                <p>Nice Job Champ!</p>
                <p>You reached <strong>Level ${this
                  .lvl}</strong>, collecting <strong>${gameData.gems} gems</strong> and <strong>${gameData.key} keys</strong> along the way, scoring a total of <strong>${gameData.score} points</strong>!!!</p>
      ...
      if (gameData.livesLeft > 0) {
        ...
        if (gameData.livesLeft === 1) {
          document
            ...
            .insertAdjacentHTML(
              "afterEnd",
              "<p class='warning'>Careful, You Don't Have Any Lives Left To Spare!</p>"
            );
        }
      }
